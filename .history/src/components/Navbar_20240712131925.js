    ...
    return (
        <div class="navbar">
            <header class="wrapper header">
                ...
                <div id="nav-buttons">
                    {/* <div><div id="donate-button" class="button button-shadow">Donate</div></div> */}
                    <button class="button btn-shadow btn-shadow--blue" id="donate-button"> <span>Donate</span> </button>
