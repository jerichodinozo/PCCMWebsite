...
import boardroompic from ".././assets/boardroom.jpg";
            ...
            <div class="rental-section">
                ...
                <div class="rental-details">
                    <div class="rental-image-container">
                        <img class="rental-image" src={boardroompic} alt="Image of the banquet hall."></img>
                    </div>
                    <div class="rental-description">
                        <h2 class="rental-title">Boardroom</h2>
                        <p>
                ...
                </div><button class="button-1 btn-shadow btn-shadow--blue" id="book-button"> <span>Book</span> </button>
