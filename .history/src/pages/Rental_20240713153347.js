            ...
            <div class="container">
                <div class="rental-section">
                    <div class="rental-selector">
                        <button id="banquet-hall-button" onClick={ () => setState({view: 1})}><h3>Banquet Hall</h3></button>
                        <button id="boardroom-button" onClick={ () => setState({view: 2})}><h3>Boardroom</h3></button>
                    </div>
                    {this.state.view === 1 ? <div id="banquet-hall">
                        ...
                        </div><button class="button btn-shadow btn-shadow--blue" id="book-button"> <span>Book</span> </button>
                    </div> :
                    this.state.view === 2?}
